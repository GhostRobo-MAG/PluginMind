"""Initial PluginMind Schema - Foundation Tables (aligned with models)
...
Aligned to app.models.database and app.models.enums.
"""
...
def upgrade() -> None:
    ...
    # Enum definitions aligned with models
    job_status_enum = sa.Enum(
        'queued', 'processing_openai', 'processing_grok', 'completed', 'failed',
        name='jobstatus'
    )
    analysis_result_status_enum = sa.Enum(
    ...
    op.create_table(
        ...
        sa.Column('cost', sa.Float(), nullable=True),
        sa.Column('status', analysis_result_status_enum, nullable=False),
