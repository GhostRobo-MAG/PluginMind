...
from app.middleware.session_auth import SessionUserDep, OptionalSessionUserDep

# Database session dependency
SessionDep = Annotated[Session, Depends(get_session)]

# Export auth dependencies for easier imports
__all__ = ["SessionDep", "UserDep", "OptionalUserDep", "SessionUserDep", "OptionalSessionUserDep"]