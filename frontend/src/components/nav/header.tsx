...
export function Header(): JSX.Element {
  ...
  return (
    <header className="sticky top-0 z-40 flex h-20 w-full border-b border-border/60 bg-background">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger
                  ...
                  className={cn(
                    ...
                    "ml-2 transition-all duration-300 ease-in-out hover:opacity-70"
                  )}
                >
                  <Avatar className="h-9 w-9">
                    {user?.image ? (
                      ...
                      <AvatarFallback className="h-9 w-9 cursor-pointer p-1.5 text-xs capitalize">
